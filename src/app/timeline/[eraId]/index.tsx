        ...
        <Card style={styles.rulesCard}>
          ...
          <View style={styles.ruleRow}>
            ...
            <Text style={[styles.ruleText, { color: colors.textSecondary }]}>
              Chạm thẻ sự kiện theo đúng thứ tự thời gian (sớm → muộn).
            </Text>
          </View>
          <View style={styles.ruleRow}>
            <Ionicons name="heart-outline" size={18} color={colors.primary} />
            <Text style={[styles.ruleText, { color: colors.textSecondary }]}>
              Bạn có 3 mạng — mỗi lần xếp sai mất 1 mạng.
            </Text>
          </View>
        </Card>
...
const styles = StyleSheet.create({
  ...
  heroCard: { alignItems: 'center', gap: SPACING[3], paddingVertical: SPACING[6] },
  heroIcon: {
    width: 96,
    height: 96,
    borderRadius: 48,
